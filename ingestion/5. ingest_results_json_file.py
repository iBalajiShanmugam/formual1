...
results_ingestion_df = add_ingestion_date(results_rename_df)
...
# spark.conf.set("spark.sql.sources.partionOverwriteMode", "dynamic")
...
overwrite_partition(results_ingestion_df, 'f1_processed','results', 'race_id')
